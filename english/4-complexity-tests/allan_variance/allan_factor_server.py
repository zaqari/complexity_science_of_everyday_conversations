...
# DATA_PATH = os.path.join(DATA_LOCATION, 'allan_var.tsv')
DATA_PATH = os.path.join(DATA_LOCATION, 'allan_var.parquet')

output_path = os.path.join(DATA_LOCATION, 'av-params.csv')
